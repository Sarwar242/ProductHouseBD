...
<body>
        <div id="loginbox">
            ...
            <form id="loginform" class="form-vertical"  action="{{url('admin')}}" method="post">
                @csrf
				 <div class="control-group normal_text"> <h3><img src="{{asset('images/backend_images/admin_login-logo.jpg')}}" alt="Logo" /></h3></div>
            ...
            <form id="recoverform" class="form-vertical" action="{{url('/admin/reset')}}" method="post">
                @csrf
